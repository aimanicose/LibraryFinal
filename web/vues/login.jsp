                ...
                <div class="row">
                    <div class="col-md-6">
                        <form name="form-login" action="vues/authentication.action" method="post">
                            ...
                            <input required name="bean.login" key="user.login" type="text" Class="form-control" oninvalid="this.setCustomValidity('Enter your UserName Please')" oninput="setCustomValidity('')"/>
                            <label>Enter Password :  </label>
                            <input required name="bean.password" key="user.password" type="password" Class="form-control" oninvalid="this.setCustomValidity('Enter your Password Please')" oninput="setCustomValidity('')"/>
                            <hr />
